	Class Meta {
			...
			/*
				...
				Examples: Lib.Obj.JSON.Dump, Lib.Obj.JSON.Load
			*/
			class Call_Functor{
			...
			*/
			Class Bypass {
				Class Object extends Lib.Obj.Meta.Bypass.Base{
					__Get(Key*) {
				...
				Class Variable extends Lib.Obj.Meta.Bypass.Base{
					__Get(Key*) {
						if(this.__Bypass(Key) == -1)
							return  this.Variable("get",Key*)
					}
				...
				Class Get extends Lib.Obj.Meta.Bypass.Base{
					__Get(Key*)	{
						if(this.__Bypass(Key) == -1)
							return this.Get(Key*)
					}
				}
				Class Set extends Lib.Obj.Meta.Bypass.Base{
					__Set(Key*)	{
						bp:=this.__Bypass(Key)
						if(bp)
				...
				Class Base extends Lib.Obj.ID.Meta_ID{
					/*
						bypass_times: 
